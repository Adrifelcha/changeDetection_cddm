...
2. *Abrupt condition.*. The mean of the Normal distribution from where the spaceship trial-by-trial locations were sampled changed 

3. *Gradual condition.* The mean of the Normal distribution from where the trial-by-trial 

4. *Mixed condition.* A mixture of the Abrupt and Gradual condition; The mean of the Normal distribution from where the trial-by-trial spaceship locations were sampled changed gradually, until a sudden and abrupt change was induced randomly, from where the mean continued to change gradually.
